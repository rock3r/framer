...
final class DeviceMonitor {
    ...
    @VisibleForTesting
    private static class DeviceListComparisonResult {

        @NonNull
        final Map<IDevice, DeviceState> updated;
        @NonNull
        final List<IDevice> added;
        @NonNull
        final List<IDevice> removed;
    ...
    static class DeviceListMonitorTask implements Runnable {
        ...
        DeviceListMonitorTask(@NonNull AndroidDebugBridge bridge,
