...
public final class Device implements IDevice {
     ...
     */
    private static final String RE_EMULATOR_SN = "emulator-(\\d+)"; //$NON-NLS-1$
        ...
        if (mount == null) {
            try {
                ...
                mMountPoints.put(name, mount);
                    ...
                    | ShellCommandUnresponsiveException | AdbCommandRejectedException ignored) {
            }
        }
        return mount;
    }
    ...
    public void pushFile(String local, String remote)
        ...
        try {
            ...
            sync = getSyncService();
            pushToDevice(local, remote, sync);
    ...
    private void pushToDevice(String local, String remote, SyncService sync)
    ...
    public String syncPackageToDevice(String localFilePath)
        ...
        try {
            ...
            sync = getSyncService();
            pushToDevice(localFilePath, remoteFilePath, sync);
    ...
    public void removeRemotePackage(String remoteFilePath) throws InstallException {
        ...
        } catch (IOException | ShellCommandUnresponsiveException | AdbCommandRejectedException | TimeoutException e) {
            throw new InstallException(e);
        }
    }
