...
final class AdbHelper {
    ...
    static class AdbResponse {
        ...
        boolean okay; // first 4 bytes in response were "OKAY"?

        String message; // diagnostic string if #okay is false
    }
     ...
     * @see DdmPreferences#getTimeOut()
     */
    private static void executeRemoteCommand(InetSocketAddress adbSockAddr, AdbService adbService, String command,
     ...
     * @throws IOException                 in case of I/O error on the connection.
     */
    static void runEventLogService(InetSocketAddress adbSockAddr, Device device, LogReceiver rcvr)
            throws TimeoutException, AdbCommandRejectedException, IOException {
     ...
     * @throws IOException                 in case of I/O error on the connection.
     */
    static void createForward(InetSocketAddress adbSockAddr, Device device, String localPortSpec, String remotePortSpec)
            throws TimeoutException, AdbCommandRejectedException, IOException {
     ...
     * @throws IOException                 in case of I/O error on the connection.
     */
    static void removeForward(InetSocketAddress adbSockAddr, Device device, String localPortSpec)
            throws TimeoutException, AdbCommandRejectedException, IOException {
     ...
     */
    private static String replyToString(byte[] reply) {
        String result;
        try {
     ...
     * @throws IOException      in case of I/O error on the connection.
     */
    private static void read(SocketChannel chan, byte[] data) throws TimeoutException, IOException {
     ...
     * @throws IOException                 in case of I/O error on the connection.
     */
    static void reboot(String into, InetSocketAddress adbSockAddr, Device device)
            throws TimeoutException, AdbCommandRejectedException, IOException {
        byte[] request;
        if (into == null) {
     ...
     * If you need to know if succeeded, you can check the result of executeRemoteCommand on 'echo \$USER_ID', if it is
     * 0 then adbd is
     * running as root.
     *
     * @throws TimeoutException            in case of timeout on the connection.
     ...
     * @throws IOException                 in case of I/O error on the connection.
     */
    static void root(@NonNull InetSocketAddress adbSockAddr, @NonNull Device device)
            throws TimeoutException, AdbCommandRejectedException, IOException {
