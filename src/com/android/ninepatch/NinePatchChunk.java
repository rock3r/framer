 ...
 */
class NinePatchChunk implements Serializable {
     ...
     */
    private static final class DrawingData {
     ...
     */
    static NinePatchChunk create(BufferedImage image) {
        NinePatchChunk chunk = new NinePatchChunk();
        chunk.findPatches(image);
        return chunk;
    }

    void draw(BufferedImage image, Graphics2D graphics2D, int x, int y, int scaledWidth,
    ...
    private void findPatches(BufferedImage image) {
        ...
        row = GraphicsUtilities.getPixels(image, 1, 0, width, 1, null);
        column = GraphicsUtilities.getPixels(image, 0, 1, 1, height, null);
