...
final class SdkConstants {
     ...
     */
    private static final String FN_GRADLE_UNIX = "gradle";                             //$NON-NLS-1$
    /**
     ...
     */
    private static final String FN_GRADLE_WRAPPER_UNIX = "gradlew";                    //$NON-NLS-1$
    /**
     ...
     */
    private static final String FN_ATTRS_XML = "attrs.xml";                            //$NON-NLS-1$
    /**
     * Name of the layout attributes, i.e. "attrs_manifest.xml"
     */
    private static final String FN_ATTRS_MANIFEST_XML = "attrs_manifest.xml";          //$NON-NLS-1$
    /**
     ...
     */
    private static final String FN_FRAMEWORK_RENDERSCRIPT = "renderscript";            //$NON-NLS-1$
    /**
     * framework include folder
     */
    private static final String FN_FRAMEWORK_INCLUDE = "include";                      //$NON-NLS-1$
    /**
     * framework include (clang) folder
     */
    private static final String FN_FRAMEWORK_INCLUDE_CLANG = "clang-include";          //$NON-NLS-1$
    /**
     * layoutlib.jar file
     */
    private static final String FN_LAYOUTLIB_JAR = "layoutlib.jar";                    //$NON-NLS-1$
    /**
     * widget list file
     */
     ...
     */
    private static final String FD_SOURCES = "src";                      //$NON-NLS-1$
    /**
     ...
     */
    private static final String FD_GRADLE = "gradle";                    //$NON-NLS-1$
    /**
     * Default gradle wrapper folder name, i.e. "gradle/wrapper"
     */
    private static final String FD_GRADLE_WRAPPER = FD_GRADLE + File.separator + "wrapper"; //$NON-NLS-1$
    /**
     ...
     */
    private static final String FD_PKG_SOURCES = "sources";              //$NON-NLS-1$
    /**
     * Name of the SDK tools folder.
     */
    private static final String FD_TOOLS = "tools";                      //$NON-NLS-1$
    /**
     ...
     */
    private static final String FD_PLATFORM_TOOLS = "platform-tools";    //$NON-NLS-1$
    /**
     * Name of the SDK build tools folder.
     */
    private static final String FD_BUILD_TOOLS = "build-tools";          //$NON-NLS-1$
    /**
     * Name of the SDK tools/lib folder.
     */
    private static final String FD_LIB = "lib";                          //$NON-NLS-1$
    /**
     * Name of the SDK docs folder.
     */
    private static final String FD_DOCS = "docs";                        //$NON-NLS-1$
    /**
     ...
     */
    private static final String FD_IMAGES = "images";                    //$NON-NLS-1$
    /**
     ...
     */
    private static final String FD_SKINS = "skins";                      //$NON-NLS-1$
    /**
     * Name of the SDK samples folder.
     */
    private static final String FD_SAMPLES = "samples";                  //$NON-NLS-1$
    /**
     ...
     */
    private static final String FD_TEMPLATES = "templates";              //$NON-NLS-1$
    /**
     * Name of the SDK Ant folder, i.e. "ant"
     */
    private static final String FD_ANT = "ant";                          //$NON-NLS-1$
    /**
     * Name of the SDK data folder, i.e. "data"
     */
    private static final String FD_DATA = "data";                        //$NON-NLS-1$
    /**
     * Name of the SDK renderscript folder, i.e. "rs"
     */
    private static final String FD_RENDERSCRIPT = "rs";                  //$NON-NLS-1$
    /**
     ...
     */
    private static final String FD_RES = "res";                          //$NON-NLS-1$
    /**
     * Name of the SDK font folder, i.e. "fonts"
     */
    private static final String FD_FONTS = "fonts";                      //$NON-NLS-1$
    /**
     * Name of the android sources directory and the root of the SDK sources package folder.
     */
    private static final String FD_ANDROID_SOURCES = "sources";          //$NON-NLS-1$
    /**
     * Name of the addon libs folder.
     */
    private static final String FD_ADDON_LIBS = "libs";                  //$NON-NLS-1$
     ...
     * This is an OS path, ending with a separator.
     */
    private static final String OS_SDK_TOOLS_FOLDER = FD_TOOLS + File.separator;

    /**
     * Path of the lib directory relative to the sdk folder, or to a platform folder.
     * This is an OS path, ending with a separator.
     */
    private static final String OS_SDK_TOOLS_LIB_FOLDER =
     ...
     * This is an OS path, ending with a separator.
     */
    private static final String OS_SDK_PLATFORM_TOOLS_FOLDER = FD_PLATFORM_TOOLS + File.separator;
     ...
     * This is an OS path, ending with a separator.
     */
    private static final String OS_PLATFORM_DATA_FOLDER = FD_DATA + File.separator;
     ...
     * This is an OS path, ending with a separator.
     */
    private static final String OS_PLATFORM_RESOURCES_FOLDER =
    ...
    private static final String CLASS_R = "android.R"; //$NON-NLS-1$
    ...
    private static final String CLASS_VIEWGROUP = "android.view.ViewGroup"; //$NON-NLS-1$
    private static final String CLASS_NAME_LAYOUTPARAMS = "LayoutParams"; //$NON-NLS-1$
    public static final String CLASS_VIEWGROUP_LAYOUTPARAMS =
            CLASS_VIEWGROUP + "$" + CLASS_NAME_LAYOUTPARAMS; //$NON-NLS-1$
    private static final String CLASS_NAME_FRAMELAYOUT = "FrameLayout"; //$NON-NLS-1$
    ...
    private static final String CLASS_NAME_PREFERENCE_SCREEN = "PreferenceScreen"; //$NON-NLS-1$
    ...
    private static final String CLASS_COORDINATOR_LAYOUT = "android.support.design.widget.CoordinatorLayout"; //$NON-NLS-1$
    private static final String CLASS_APP_BAR_LAYOUT = "android.support.design.widget.AppBarLayout"; //$NON-NLS-1$
    private static final String CLASS_FLOATING_ACTION_BUTTON = "android.support.design.widget.FloatingActionButton"; //$NON-NLS-1$
    private static final String CLASS_COLLAPSING_TOOLBAR_LAYOUT = "android.support.design.widget.CollapsingToolbarLayout"; //$NON-NLS-1$
    private static final String CLASS_NAVIGATION_VIEW = "android.support.design.widget.NavigationView"; //$NON-NLS-1$
    private static final String CLASS_SNACKBAR = "android.support.design.widget.Snackbar"; //$NON-NLS-1$
    private static final String CLASS_TAB_LAYOUT = "android.support.design.widget.TabLayout"; //$NON-NLS-1$
    private static final String CLASS_TEXT_INPUT_LAYOUT = "android.support.design.widget.TextInputLayout"; //$NON-NLS-1$
     ...
     */
    private static final String FD_RES_VALUES = "values"; //$NON-NLS-1$
    /**
     ...
     * Namespace used in XML files for Android attributes
     */
    static final String ANDROID_URI =
            "http://schemas.android.com/apk/res/android";              //$NON-NLS-1$
    /**
    ...
    // Tags: Data-Binding
    private final String TAG_LAYOUT = "layout";                  //$NON-NLS-1$
    private final String TAG_DATA = "data";                      //$NON-NLS-1$
    private final String TAG_VARIABLE = "variable";              //$NON-NLS-1$
    private final String TAG_IMPORT = "import";                  //$NON-NLS-1$
     ...
     */
    private static final String EXT_ANDROID_PACKAGE = "apk"; //$NON-NLS-1$
    /**
     ...
     */
    private static final String EXT_AIDL = "aidl"; //$NON-NLS-1$
    /**
     * Extension of Renderscript files, i.e. "rs"
     */
    private static final String EXT_RS = "rs"; //$NON-NLS-1$
    /**
     * Extension of Renderscript files, i.e. "rsh"
     */
    private static final String EXT_RSH = "rsh"; //$NON-NLS-1$
    /**
     * Extension of FilterScript files, i.e. "fs"
     */
    private static final String EXT_FS = "fs"; //$NON-NLS-1$
    /**
     * Extension of Renderscript bitcode files, i.e. "bc"
     */
    private static final String EXT_BC = "bc"; //$NON-NLS-1$
    /**
     * Extension of dependency files, i.e. "d"
     */
    private static final String EXT_DEP = "d"; //$NON-NLS-1$
    /**
     * Extension of native libraries, i.e. "so"
     */
    private static final String EXT_NATIVE_LIB = "so"; //$NON-NLS-1$
    /**
     * Extension of dex files, i.e. "dex"
     */
    private static final String EXT_DEX = "dex"; //$NON-NLS-1$
    /**
     * Extension for temporary resource files, ie "ap_
     */
    private static final String EXT_RES = "ap_"; //$NON-NLS-1$
    /**
     ...
     */
    private static final String EXT_AAR = "aar"; //$NON-NLS-1$
    /**
     * Extension for Java heap dumps.
     */
    private static final String EXT_HPROF = "hprof"; //$NON-NLS-1$
     ...
     */
    private static final String FN_RESOURCE_BASE = "R"; //$NON-NLS-1$
    /**
     ...
     */
    private static final String FN_MANIFEST_BASE = "Manifest";          //$NON-NLS-1$
    /**
     * Generated BuildConfig class name
     */
    private static final String FN_BUILD_CONFIG_BASE = "BuildConfig";   //$NON-NLS-1$
    /**
    ...
    // Packages
    private static final String ANDROID_PKG_PREFIX = "android.";         //$NON-NLS-1$
    ...
    private static final String SUPPRESS_LINT = "SuppressLint";           //$NON-NLS-1$
    private static final String TARGET_API = "TargetApi";                 //$NON-NLS-1$
    ...
    private static final String GRADLE_PLUGIN_RECOMMENDED_VERSION = "2.0.0-rc1";
    ...
    // Annotations
    private static final String SUPPORT_ANNOTATIONS_PREFIX = "android.support.annotation.";
